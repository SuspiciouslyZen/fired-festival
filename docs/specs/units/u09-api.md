...
- [[u01-models]] — `src/harness/models.py` (`Alert`, `CheckpointStage`, `EscalationDecision`)
- [[u02-guardrails]] — `src/harness/guardrails.py` (`GuardrailEngine`)
- [[u04-checkpoints]] — `src/db/store.py` (`CheckpointStore`)
- [[u05-material]] — `src/harness/material.py` (`MaterialHandler`)
- [[u06-tools]] — `src/tools/__init__.py` (`create_registry`)
- [[u07-loop]] — `src/harness/loop.py` (`HarnessLoop`)
- [[u08-agents]] — `src/agents/claude_agent.py`, `src/agents/openai_agent.py`
