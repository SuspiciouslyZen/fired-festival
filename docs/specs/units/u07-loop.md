...
- [[u01-models]] — `src/harness/models.py` (all models)
- [[u02-guardrails]] — `src/harness/guardrails.py` (`GuardrailEngine`)
- [[u03-alarms]] — `src/harness/alarms.py` (`AlarmManager`)
- [[u04-checkpoints]] — `src/harness/checkpoints.py` (`CheckpointManager`), `src/db/store.py` (`CheckpointStore`)
- [[u05-material]] — `src/harness/material.py` (`MaterialHandler`)
- [[u06-tools]] — `src/tools/registry.py` (`ToolRegistry`)
- [[u01-models]] `src/agents/base.py` (`BaseAgent`)
